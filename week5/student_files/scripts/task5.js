...
document.getElementById('message2').innerText = anotherMsg;
...
async function getTemples(url) {
    ...
    templesList = await respuesta.json();
    output(templesList);
    }
}
...
function sortBy(){
    ...
    const sortedList = templesList.sort(function(a, b){
        if ( a.templeName.toLowerCase() < b.templeName.toLowerCase() ){
            return -1;
        }
        if ( a.templeName.toLowerCase() > b.templeName.toLowerCase() ){
            return 1;
